...
class Person:
  def __init__(self, name, email, skills=[], education=[], projects=[], company = None):
    self.name = name
    self.email = email
    self.skills = skills
...
stephanie = Person("Stephanie Hutson", "stephanie.m.hutson@gmail.com", ["Python", "Ruby", "JavaScript", "R", "MVC", "REST", "data", "Object-Oriented Programming"], [dev_bootcamp, pvcc, univeristy_of_virginia, univeristy_of_edinburgh], [train_all, pitch_it, co2_emissions, pixie_report])

#### The Meat of it all

stephanie.personal_statement = "I started prgramming as a pre-teen, and after a decade of toying - laced into a life of science, sport, and entrepreneurship - and a year and a half of focused study, I now find myself able to build applications from the ground up and as excited as ever to learn, grown, and build. I have a passion for working with data through data visualization and backend data management. I love taking a pile of information, be it from a mongoDB, a CSV, or a relational database, and turn it into something meaningful. \n\nMy background in environmental science lends a unique set of skills and understanding about the physical world, while my experience as a small business owner and in anthropology/archaeology helps me understand clients' needs, and the human aspect of an application."
